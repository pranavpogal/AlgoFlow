...
CURATED_PROBLEMS_BY_NUMBER = {
    ...
    "198": {
        ...
        "subpatterns": ["Include-Exclude Decision", "Linear DP", "State Compression"],
    ...
    "55": {
        "difficulty": "Medium",
        "primary_pattern": "greedy_sorting",
        "primary_pattern_label": "Farthest Reach Greedy",
        "subpatterns": ["Reachability Frontier", "Running Maximum", "Local State Compression"],
        "structural_cues": ["track the farthest index reachable so far", "fail only when the current index passes the reach frontier"],
        "prerequisites": ["Arrays", "Greedy Reasoning", "Reachability"],
        "related_patterns": ["Greedy Level Expansion", "Linear DP Alternative"],
        "confidence": 0.96,
    },
    "45": {
        "difficulty": "Medium",
        "primary_pattern": "greedy_sorting",
        "primary_pattern_label": "Greedy Level Expansion",
        "subpatterns": ["Current Range Boundary", "Farthest Next Reach", "Implicit BFS Layers"],
        "structural_cues": ["current jump covers a range of indices", "choose the farthest next reach before crossing the range boundary"],
        "prerequisites": ["Arrays", "Greedy Reasoning", "Range Tracking"],
        "related_patterns": ["BFS Traversal", "Farthest Reach Greedy"],
        "confidence": 0.96,
    },
    "435": {
        "difficulty": "Medium",
        "primary_pattern": "greedy_sorting",
        "primary_pattern_label": "Earliest Finish Time",
        "subpatterns": ["Interval Scheduling", "Sort by End Time", "Maximum Compatible Subset"],
        "structural_cues": ["sorting by earliest end preserves the most future room", "minimum removals equals total intervals minus maximum compatible subset"],
        "prerequisites": ["Sorting", "Intervals", "Greedy Reasoning"],
        "related_patterns": ["Interval Merge", "Weighted Interval Scheduling"],
        "confidence": 0.95,
    },
    "452": {
        "difficulty": "Medium",
        "primary_pattern": "greedy_sorting",
        "primary_pattern_label": "Interval Endpoint Greedy",
        "subpatterns": ["Sort by End Coordinate", "Maximum Overlap Reuse", "Interval Covering"],
        "structural_cues": ["shooting at the earliest ending balloon maximizes overlap reuse", "new arrow is needed only after an interval starts beyond the current endpoint"],
        "prerequisites": ["Sorting", "Intervals", "Greedy Reasoning"],
        "related_patterns": ["Earliest Finish Time", "Interval Covering"],
        "confidence": 0.95,
    },
    "763": {
        "difficulty": "Medium",
        "primary_pattern": "greedy_sorting",
        "primary_pattern_label": "Greedy Boundary Expansion",
        "subpatterns": ["Last Occurrence Tracking", "Dynamic Segment Boundary", "Partition Closure"],
        "structural_cues": ["a partition closes only after every character inside reaches its last occurrence", "boundary expands greedily as new letters appear"],
        "prerequisites": ["Strings", "Arrays or Hash Maps", "Greedy Reasoning"],
        "related_patterns": ["Two Pointers", "Frequency Counting"],
        "confidence": 0.95,
    },
    "1029": {
        "difficulty": "Medium",
        "primary_pattern": "greedy_sorting",
        "primary_pattern_label": "Sort by Opportunity Cost",
        "subpatterns": ["Cost Difference Ordering", "Relative Advantage", "Balanced Assignment"],
        "structural_cues": ["relative cost difference determines who should go to city A", "balanced assignment is satisfied after sorting by opportunity cost"],
        "prerequisites": ["Sorting", "Greedy Reasoning", "Arrays"],
        "related_patterns": ["Exchange Argument", "Assignment Greedy"],
        "confidence": 0.95,
    },
    "881": {
        "difficulty": "Medium",
        "primary_pattern": "opposing_pointers",
        "primary_topic_label": "Greedy",
        "primary_pattern_label": "Sort and Two Pointers",
        "subpatterns": ["Pair Heaviest with Lightest", "Extremal Choice", "Capacity Matching"],
        "structural_cues": ["the heaviest remaining person must take a boat now", "pair with the lightest remaining person when capacity allows"],
        "prerequisites": ["Sorting", "Two Pointers", "Greedy Reasoning"],
        "related_patterns": ["Opposing Pointers", "Exchange Argument"],
        "confidence": 0.95,
    },
    "621": {
        "difficulty": "Medium",
        "primary_pattern": "greedy_sorting",
        "primary_pattern_label": "Frequency-Based Greedy Scheduling",
        "subpatterns": ["Maximum Frequency Bottleneck", "Idle Slot Counting", "Priority Queue Alternative"],
        "structural_cues": ["the most frequent task determines the schedule frame", "idle slots are filled by remaining frequencies"],
        "prerequisites": ["Frequency Counting", "Greedy Reasoning", "Heaps"],
        "related_patterns": ["Priority Queue", "Counting"],
        "confidence": 0.94,
    },
    "646": {
        "difficulty": "Medium",
        "primary_pattern": "greedy_sorting",
        "primary_pattern_label": "Earliest Finish Time",
        "subpatterns": ["Interval Scheduling", "Sort by Right Endpoint", "DP Alternative"],
        "structural_cues": ["choose the pair with earliest right endpoint to leave room for future pairs", "unweighted chain length allows a safe greedy finish-time choice"],
        "prerequisites": ["Sorting", "Intervals", "Greedy Reasoning"],
        "related_patterns": ["LIS-style DP", "Interval Scheduling"],
        "confidence": 0.95,
    },
    "376": {
        "difficulty": "Medium",
        "primary_pattern": "greedy_sorting",
        "primary_pattern_label": "Greedy Trend Tracking",
        "subpatterns": ["Peak-Valley Selection", "Sign Change Detection", "Constant-State Compression", "DP Alternative"],
        "structural_cues": ["only sign changes between consecutive differences extend the wiggle", "peaks and valleys can replace intermediate points"],
        "prerequisites": ["Arrays", "Subsequences", "Greedy Reasoning"],
        "related_patterns": ["Decision DP", "State Compression"],
        "confidence": 0.94,
    },
    "122": {
        "difficulty": "Medium",
        "primary_pattern": "greedy_sorting",
        "primary_pattern_label": "Accumulate Positive Gains",
        "subpatterns": ["Local Profit Capture", "Monotonic Segment Decomposition", "DP Alternative"],
        "structural_cues": ["unlimited transactions allow every positive day-to-day gain to be captured", "monotonic rises decompose into local profits"],
        "prerequisites": ["Arrays", "Greedy Reasoning"],
        "related_patterns": ["Stock DP", "Peak-Valley Greedy"],
        "confidence": 0.95,
    },
    "213": {
        "difficulty": "Medium",
        "primary_pattern": "decision_dp",
        "primary_pattern_label": "Circular Case Reduction to Linear DP",
        "subpatterns": ["Two Scenario Decomposition", "Take-or-Skip DP", "State Compression"],
        "structural_cues": ["first and last houses cannot both be selected", "solve two linear robber scenarios and take the better result"],
        "prerequisites": ["Linear DP", "Arrays", "Circular Constraints"],
        "related_patterns": ["Take-or-Skip DP", "State Compression"],
        "confidence": 0.96,
    },
    "322": {
        "difficulty": "Medium",
        "primary_pattern": "knapsack_dp",
        "primary_pattern_label": "Unbounded Knapsack DP",
        "subpatterns": ["Minimum-State Transition", "Reusable Choices", "Bottom-Up DP"],
        "structural_cues": ["each coin denomination can be reused", "minimum coins for an amount depends on smaller amounts"],
        "prerequisites": ["Dynamic Programming", "Arrays", "Optimization Problems"],
        "related_patterns": ["Subset Sum", "Shortest Path on Amounts"],
        "confidence": 0.96,
    },
    "139": {
        "difficulty": "Medium",
        "primary_pattern": "decision_dp",
        "primary_pattern_label": "Prefix Segmentation DP",
        "subpatterns": ["Reachable Prefix States", "Dictionary Lookup", "Partition DP"],
        "structural_cues": ["valid segmentation of a prefix can be reused by later prefixes", "dictionary lookup checks candidate cuts"],
        "prerequisites": ["Strings", "Hash Sets", "Dynamic Programming"],
        "related_patterns": ["Trie Prefix Search", "Partition DP"],
        "confidence": 0.95,
    },
    "91": {
        "difficulty": "Medium",
        "primary_pattern": "decision_dp",
        "primary_pattern_label": "Prefix Counting DP",
        "subpatterns": ["One-Character Transition", "Two-Character Transition", "Rolling State"],
        "structural_cues": ["each prefix count depends on valid one-digit and two-digit decodes", "overlapping prefix states make greedy commitment unsafe"],
        "prerequisites": ["Strings", "Dynamic Programming"],
        "related_patterns": ["Rolling DP", "Digit DP"],
        "confidence": 0.95,
    },
    "416": {
        "difficulty": "Medium",
        "primary_pattern": "knapsack_dp",
        "primary_pattern_label": "0/1 Knapsack",
        "subpatterns": ["Subset Sum", "Boolean State Reachability", "Space Optimization"],
        "structural_cues": ["each number is used at most once", "target reachability is a subset-sum state"],
        "prerequisites": ["Dynamic Programming", "Subset Sum", "Arrays"],
        "related_patterns": ["0/1 Choice DP", "Boolean DP"],
        "confidence": 0.96,
    },
    "300": {
        "difficulty": "Medium",
        "primary_pattern": "lis_dp",
        "primary_topic_label": "Dynamic Programming and Binary Search",
        "primary_pattern_label": "Longest Increasing Subsequence",
        "subpatterns": ["O(n^2) DP", "Patience Sorting", "Tails Array", "Binary Search Optimization"],
        "structural_cues": ["subsequence order must be preserved", "tails array supports binary-search optimization"],
        "prerequisites": ["Subsequences", "Dynamic Programming", "Binary Search"],
        "related_patterns": ["Patience Sorting", "Weighted LIS"],
        "confidence": 0.96,
    },
    "673": {
        "difficulty": "Medium",
        "primary_pattern": "lis_dp",
        "primary_pattern_label": "LIS with Count Tracking",
        "subpatterns": ["Length DP", "Count DP", "Predecessor Aggregation"],
        "structural_cues": ["counting LIS requires aggregating predecessor counts", "length and count states move together"],
        "prerequisites": ["Longest Increasing Subsequence", "Dynamic Programming"],
        "related_patterns": ["LIS-style DP", "Counting DP"],
        "confidence": 0.95,
    },
    "354": {
        "difficulty": "Hard",
        "primary_pattern": "lis_dp",
        "primary_topic_label": "Dynamic Programming and Binary Search",
        "primary_pattern_label": "Sort and Reduce to LIS",
        "subpatterns": ["Width Ascending Sort", "Height Descending Tie-Break", "LIS on Second Dimension"],
        "structural_cues": ["sorting removes one dimension of nesting", "descending tie-break prevents equal-width envelopes from chaining"],
        "prerequisites": ["Sorting", "Longest Increasing Subsequence", "Binary Search"],
        "related_patterns": ["Patience Sorting", "2D Ordering"],
        "confidence": 0.95,
    },
    "1626": {
        "difficulty": "Medium",
        "primary_pattern": "lis_dp",
        "primary_pattern_label": "Weighted LIS",
        "subpatterns": ["Sort Then DP", "Maximum-Sum Increasing Subsequence", "Compatibility Transition"],
        "structural_cues": ["players are sorted to impose compatibility order", "score objective turns LIS into weighted DP"],
        "prerequisites": ["Sorting", "Dynamic Programming", "LIS Variants"],
        "related_patterns": ["Weighted Interval Scheduling", "LIS-style DP"],
        "confidence": 0.94,
    },
    "1235": {
        "difficulty": "Hard",
        "primary_pattern": "interval_dp",
        "primary_topic_label": "Dynamic Programming and Binary Search",
        "primary_pattern_label": "Weighted Interval Scheduling",
        "subpatterns": ["Sort by Time", "Binary Search Previous Compatible Job", "Take-or-Skip DP"],
        "structural_cues": ["job profit weights invalidate earliest-finish greedy", "binary search finds the previous compatible job for the DP recurrence"],
        "prerequisites": ["Dynamic Programming", "Binary Search", "Intervals"],
        "related_patterns": ["Take-or-Skip DP", "Interval Scheduling"],
        "confidence": 0.95,
    },
    "1143": {
        "difficulty": "Medium",
        "primary_pattern": "lcs_dp",
        "primary_pattern_label": "Two-Sequence DP",
        "subpatterns": ["Match-or-Skip Transition", "2D DP", "Space Optimization"],
        "structural_cues": ["two input strings require a 2D state", "matching characters advance both sequences while skips advance one"],
        "prerequisites": ["Strings", "Dynamic Programming", "Subsequences"],
        "related_patterns": ["Edit Distance", "Two-Sequence DP"],
        "confidence": 0.96,
    },
}
